...
public class ClienteRevendedor extends Cliente {
    ...
    public String toString() {
        return "Cliente Revendedor {ID=" + getId() + " | Nome='" + getNome() + '\'' + " | NIF='" + "Telefone='" + getTelefone() + " | Email='" + getEmail() + " | Desconto em Peças=" + descontoPecas + "%" + " | Desconto em Mão de Obra=" + descontoMaoObra + "%}";
    }
}
